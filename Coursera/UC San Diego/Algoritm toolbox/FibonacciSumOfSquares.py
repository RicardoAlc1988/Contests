...
def last_digit_fibonacci_sum_squares(n: int):
    F_n = huge_fibonacci_digit(n, 10)
    F_n_plus_one = huge_fibonacci_digit(n+1, 10)
...
def main():
    ...
    for n in input:
        print(last_digit_fibonacci_sum_squares(n))
